    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-purple-600 via-purple-700 to-indigo-800 text-white">
            {!generatedWebsite ? (
                    ...
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        <form onSubmit={handleSubmit} className="mb-12">
                            <div className="relative max-w-2xl mx-auto">
                                <input
                                    ...
                                    className="w-full px-6 py-4 rounded-full bg-purple-800/50 border border-purple-500/50 focus:outline-none focus:ring-2 focus:ring-white/25 text-white placeholder-white/70"
                                />
                                <button
                                    type="submit"
                                    disabled={isGenerating}
                                    className="absolute right-2 top-1/2 transform -translate-y-1/2 bg-white/20 hover:bg-white/30 p-3 rounded-full transition-colors disabled:opacity-50"
                                >
                                    {isGenerating ? (
                        ...
                        <div className="flex flex-wrap justify-center gap-4">
                            <button
                                ...
                                className="px-6 py-3 rounded-full bg-white/10 hover:bg-white/20 border border-white/20"
                            >
                                Landing Page
                            </button>
                            <button
                ...
                <div>
                    <div className="bg-purple-900 p-4 sticky top-0 z-50 flex justify-between items-center">
                        <button
