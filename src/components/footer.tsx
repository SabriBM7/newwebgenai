            ...
            <div className="container mx-auto px-4 py-12">
              ...
              <span className="text-2xl font-bold text-white">
                WebGen<span className="text-purple-500">AI</span>
                        ...
                        <p className="mt-4 text-gray-400">Create stunning websites in minutes with the power of AI</p>
                    </div>
                ...
                <div className="mt-12 pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center">
                    <p className="text-gray-500">© {new Date().getFullYear()} WebGenAI. All rights reserved.</p>
